...
import ReportsAnimation from '../../components/ReportsAnimation';
    ...
    <Layout>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div ref={titleRef} className="mb-6 flex justify-between items-center flex-col md:flex-row">
          ...
          <div className="flex space-x-4 flex-wrap gap-y-2 p-3 bg-gray-800 rounded-lg shadow-md">
            <div className="flex items-center space-x-2">
              <label className="text-sm font-bold text-white">From:</label>
              <select 
                name="startMonth" 
                value={startMonth} 
                onChange={handleDateChange} 
                className="select select-sm bg-gray-700 text-white border border-gray-600"
                disabled={loading}
              >
            ...
            <div className="flex items-center space-x-2">
              <label className="text-sm font-bold text-white">To:</label>
              <select 
                name="endMonth" 
                value={endMonth} 
                onChange={handleDateChange} 
            ...
            <button 
              ...
              disabled={loading}
            >
              <i className="fas fa-sync-alt mr-1"></i> Apply
            </button>
          </div>
        </div>
